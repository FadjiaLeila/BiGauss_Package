# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 18:52:00 2020
...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        p = (math.factorial(self.n)/(math.factorial(k)*(math.factorial(self.n-k)))) * (self.p**k)*((1-self.p)**(self.n -k))
        return p
        pass        
    ...
    def plot_bar_pdf(self):
        ...
        #   The x and y values should be stored in separate lists
         # calculate the values to be visualized
        x =[]
        y= []
